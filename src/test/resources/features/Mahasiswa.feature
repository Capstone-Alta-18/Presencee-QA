Feature: User started to use Presencee feature "Mahasiswa"
  ...
  @PresenceeAPI @MahasiswaPresencee @UpdateMahasiswa
    ...
    Then User verify status code is 200
    And User get auth token
    Given User call an api "mahasiswa" with method "PUT" with payload below
      | name         | email                | nim        | image | phone        | jurusan   | tahun_masuk | ipk  | user_id    | path_variable       |
      | Eliasz Moses| eliaszmoses@gmail.com | 7193220000 | null  | 081364287070 | Akuntansi | 2019        | 3,78 | 563267194 | 49 |
    Then User verify status code is 200
